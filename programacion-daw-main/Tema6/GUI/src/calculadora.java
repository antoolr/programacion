...
public class calculadora extends JFrame implements ActionListener {
 ...
 String[] botones = { "7", "8", "9", "/", "V", "4", "5", "6", "x^", "*", "1", "2", "3", "-", "C", "0", "=", "+" };
 ...
 add(panelBotones, BorderLayout.CENTER); setVisible(true);
 }
 ...
 case "-": resultado = num1 - num2; break;
 case "*": resultado = num1 * num2; break;
 case "V": resultado = num1 * num1; break;
